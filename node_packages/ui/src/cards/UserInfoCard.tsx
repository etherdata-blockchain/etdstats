...
export default function ProfileCover({ name, wallet, avatar }: Profile) {
  return (
    <RootStyle>
      <InfoStyle>
        <Avatar
        ...
        >
          ...
          <Typography sx={{ opacity: 0.72 }}>{wallet}</Typography>
        </Box>
      </InfoStyle>
    </RootStyle>
  );
...
export function UserInfoCard({ name, wallet, avatar }: Props) {
  ...
  return (
    ...
    >
      <ProfileCover name={name} wallet={wallet} avatar={avatar} />
