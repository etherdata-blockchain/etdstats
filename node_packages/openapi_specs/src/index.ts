import analytics_service_schema from "./analytics_service.json"
import block_info_service_schema from "./block_info_service.json"
...
export {
  analytics_service_schema,
  block_info_service_schema,
